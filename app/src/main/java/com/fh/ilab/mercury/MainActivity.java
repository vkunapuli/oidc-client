...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupAuthConfigPING(String issuer, String clientId)
    {
        ...
        //authConfig.putString("redirectUrl",  "com.pmmercurydemoapp:/callback");//CTE
        //authConfig.putString("redirectUrl",  "com.pmmercurydemoapp.uat:/callback");//UAT
        authConfig.putString("redirectUrl",  "com.fh.ilab.mercury:/callback");//DEV/SIT
        authConfig.putString("scopes",       "openid, profile, email");//reddiebuyer
    }

    private void setupAuthConfigBundle()
    {
        authConfig = new Bundle();
        authConfig.putString("issuer",       "https://dev-973927.okta.com//oauth2/default");
        authConfig.putString("clientId",     "0oa276g4opiG7EEe8357");
        authConfig.putString("redirectUrl",  "com.okta.dev-973927:/callback");
        authConfig.putString("scopes",       "openid, profile, email, offline_access");
    }
    private void setupAuthGoogle()
    {
        authConfig = new Bundle();
        authConfig.putString("issuer",       "https://accounts.google.com");
        authConfig.putString("clientId",     "GOOGLE_OAUTH_APP_GUID.apps.googleusercontent.com");
        //authConfig.putString("clientSecret", "0oa276g4opiG7EEe8357");
        authConfig.putString("redirectUrl",  "ccom.googleusercontent.apps.GOOGLE_OAUTH_APP_GUID:/oauth2redirect/google");
        authConfig.putString("scopes",       "openid, profile, email, offline_access");
    }
